                        ...
                        <>
                            ...
                            <div style={{ padding: '24px 28px', borderBottom: '1px solid var(--border)', background: 'var(--surface)' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
                                    ...
                                    <select className="form-input" value={selected.Status} onChange={e => {
                                        const newVal = e.target.value;
                                        changeStatus(newVal);
                                    }} style={{ padding: '8px 16px', minWidth: '140px', fontWeight: 700, fontSize: '12px', background: STATUS_COLORS[selected.Status]?.bg, color: STATUS_COLORS[selected.Status]?.color, border: 'none', borderRadius: '20px', cursor: 'pointer', appearance:'none', textAlign:'center', outline:'none' }}>
